...
class CArgosRosBotLit : public CCI_Controller {

public:

  CArgosRosBotLit();
  virtual ~CArgosRosBotLit() {}
...
private:
  ...
  constexpr static const Real HALF_BASELINE = 0.07f; // Half the distance between wheels
  constexpr static const Real WHEEL_RADIUS = 0.029112741f;
