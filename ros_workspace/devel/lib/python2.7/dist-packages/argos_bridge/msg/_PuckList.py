...
"""autogenerated by genpy from argos_bridge/PuckList.msg. Do not edit."""
import codecs
import sys
...
class PuckList(genpy.Message):
  _md5sum = "7c7beefd16ea3674a7f0d4b1ea8d5d76"
  _type = "argos_bridge/PuckList"
...
float32 a
"""
  __slots__ = ['header','n','pucks']
  _slot_types = ['std_msgs/Header','int32','argos_bridge/Puck[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PuckList, self).__init__(*args, **kwds)
